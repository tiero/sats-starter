...
export default function Home() {
  ...
  const [contributionModalIsVisible, setContributionModalAsVisible] = useState(false);
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Launch your crowdfunding campaign without intermediaries" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <section className="hero is-medium is-primary">
        <div className="hero-body">
          <h1 className='title'>⚡️ Sats Starter</h1>
          <p className="subtitle">Launch your crowdfunding campaign without intermediaries</p>
        </div>
      </section>
